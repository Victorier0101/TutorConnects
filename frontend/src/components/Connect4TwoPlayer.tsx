...
const Connect4TwoPlayer = () => {
  ...
  const handleColumnClick = useCallback((col: number) => {
    ...
    if (gameWinner) {
      ...
      if (gameWinner === 1) {
        setGameStats(prev => ({ ...prev, player1Wins: prev.player1Wins + 1 }));
      } else {
        setGameStats(prev => ({ ...prev, player2Wins: prev.player2Wins + 1 }));
      }
      return;
    }
  ...
  }, [board, currentPlayer, isGameActive, makeMove, checkWinner, isBoardFull]);
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Box>
              ...
              >
                Connect 4 - Two Players
              </Typography>
              <Typography variant="h6" color="text.secondary">
                Challenge your friend and connect four in a row!
              </Typography>
            </Box>
          </Box>
                ...
                {Array.from({length: COLS}, (_, col) => (
                  <Box
                    ...
                    sx={{
                      ...
                      height: '60px',
                      borderRadius: '50%',
                      background: hoverColumn === col && isGameActive
                        ? currentPlayer === 1
                          ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'
                          : 'linear-gradient(135deg, #10b981 0%, #059669 100%)'
                        : 'transparent',
            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Typography variant="body2">Player 1 Wins:</Typography>
                  <Chip 
                    label={gameStats.player1Wins} 
                    size="small" 
                    color="primary"
                    sx={{ fontWeight: 600 }}
                  />
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Typography variant="body2">Player 2 Wins:</Typography>
                  <Chip 
                    label={gameStats.player2Wins} 
                    size="small" 
                    color="success"
                    sx={{ fontWeight: 600 }}
                  />
        ...
        <DialogContent sx={{ textAlign: 'center' }}>
          <Typography variant="h6" color="text.secondary">
            {winner === 'draw' ? "Nobody wins this time. Try again!" :
             winner === 1 ? "Congratulations Player 1! Well played!" : 
             "Congratulations Player 2! Great game!"}
          </Typography>
        </DialogContent>
...
export default Connect4TwoPlayer; 